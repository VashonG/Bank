    ...
    var body: some View {
        HStack {
            Button(action: {}, label: {
                HStack(spacing: 0) {
                    Text(StringConstants.kLbl27)
                        ...
                        .foregroundColor(ColorConstants.Purple300)
            ...
            VStack(alignment: .leading, spacing: 0) {
                Text(StringConstants.kLblSketchApp)
                    ...
                    .frame(width: getRelativeWidth(175.0), height: getRelativeHeight(22.0),
                           alignment: .leading)
                Text(StringConstants.kLbl930Am)
            ...
            Text(StringConstants.kLbl9900)
                .font(FontScheme.kSFProSemibold(size: getRelativeHeight(17.0)))
                .fontWeight(.semibold)
                .foregroundColor(ColorConstants.Black900)
                .minimumScaleFactor(0.5)
                .multilineTextAlignment(.trailing)
                .frame(width: getRelativeWidth(59.0), height: getRelativeHeight(22.0),
                       alignment: .trailing)
...
/* struct Content5Cell_Previews: PreviewProvider {
